...
int main() {
    ...
    Shader cube("res/Shader/Cube.vert", "res/Shader/Cube.frag");
    Camera camera(SCR_WIDTH, SCR_HEIGHT, {5.0f, 0.0f, 0.0f});
...
int main()
{
    ...
    for(int x = 0; x <= 16; x++) {
        for(int y = 0; y <= 16; y++) {
            for(int z = 0; z <= 16; z++) {
                cubes.push_back(glm::vec3(1.0f * x, 1.0f * y, 1.0f * z));
            }
        }
    }
    ...
    Camera camera(SCR_WIDTH, SCR_HEIGHT, {2.0f, 0.0f, 0.0f});
